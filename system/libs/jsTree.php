...
function jsNode_class(tree, parent, id, text) {
    this.id     	= id;
	this.ind		= null; 
    this.text   	= text;
    this.tree   	= tree;
...
function jsTree_class(name, box) {
    // required
    this.name   = name;
    this.box    = box;
    ...
    // internal properties
    this.LplusDotsImg   = top.jsLoader.sys_path + "/images/Lplus.png";
    this.TplusDotsImg   = top.jsLoader.sys_path + "/images/Tplus.png";
    this.LminusDotsImg  = top.jsLoader.sys_path + "/images/Lminus.png";
    this.TminusDotsImg  = top.jsLoader.sys_path + "/images/Tminus.png";
    this.IclearDotsImg  = top.jsLoader.sys_path + "/images/I.png";
    this.LclearDotsImg  = top.jsLoader.sys_path + "/images/L.png";
    this.TclearDotsImg  = top.jsLoader.sys_path + "/images/T.png";
    this.plusNotDotsImg = top.jsLoader.sys_path + "/images/plus.png";
    this.minusNotDotsImg= top.jsLoader.sys_path + "/images/minus.png";
...
top.jsNode = jsNode_class;
top.jsTree = jsTree_class;
...
function jsTree_addNode (parent, id, text) {
    ...
    var node = new jsNode_class(this, parent, id, text);
...
function jsTree_refresh(node) {
	...
	if (!node && this.box.ownerDocument != null) { // entire tree
	    ...
	    if (cellImg > '') {
	        if (document.all) {
	            cellImg = '<img src="'+ top.jsLoader.sys_path +'/images/empty.gif" style="filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src=\''+ cellImg +'\'")>';
	        } else {
...
// Class is Loaded
if (top.jsLoader) top.jsLoader.loadFileDone('jsTree.js');